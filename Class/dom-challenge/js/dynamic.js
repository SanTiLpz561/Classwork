...
actionList.addEventListener('click', (e) => {
    ...
    if (action === 'toggle') {
        ...
        if(currentCard.previousElementSibling) {
            currentCard.parentNode.insertBefore(currentCard, currentCard.previousElementSibling)
        } else { return; }
        ...
        if(currentCard.nextElementSibling) {
            currentCard.parentNode.insertBefore(currentCard.nextElementSibling, currentCard)
        } else { return; }
